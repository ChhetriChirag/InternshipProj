  ...
  return (
    <div className="space-y-6">
      <section className="glass-card p-5">
        ...
        <p className="mt-1 text-slate-400">See your emotional trends and progress over time.</p>
      </section>
      {loading ? (
        <div className="glass-card p-8 text-center text-slate-300">Loading entries...</div>
      ) : (
        <>
